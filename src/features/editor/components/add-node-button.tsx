...
export const AddNodeButton = memo(() => {
  ...
  return (
    <Button
      ...
      className={cn(
        "w-full md:w-auto h-12 md:h-10 text-sm text-white transition-all duration-500 ease-[cubic-bezier(0.23,1,0.32,1)] group border-0 px-4 gap-2 font-medium shadow-md overflow-hidden relative",
        selectorOpen 
      ...
      <div className="flex items-center gap-2 relative z-10">
        {selectorOpen ? (
          ...
          <>
            ...
            <span className="hidden sm:inline">Add Triggers & Actions</span>
